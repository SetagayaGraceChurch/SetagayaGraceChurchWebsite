...
const NETLIFY_BUILD_HOOK_URL = 'PUT_YOUR_NETLIFY_BUILD_HOOK_HERE';
...
function doGet() {
  ...
  return ContentService
    .createTextOutput(JSON.stringify({
      sermons: readSheetRows_(spreadsheet, SERMONS_SHEET_NAME),
      events: readSheetRows_(spreadsheet, EVENTS_SHEET_NAME),
      staff: readSheetRows_(spreadsheet, STAFF_SHEET_NAME),
    }))
